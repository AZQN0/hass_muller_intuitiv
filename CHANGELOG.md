...
### Fixed
- Keep Codecov upload issues from failing otherwise successful test matrix jobs.

## [0.11.3] - 2026-05-15

### Fixed
- Restore GitHub Actions compatibility by updating artifact upload to v4.
- Install a Python 3.11/3.12-compatible Home Assistant test dependency in CI.
- Make the test frame helper compatible with the pinned Home Assistant version.
- Align Black, isort, and flake8 configuration so quality checks run on project code consistently.

## [0.11.2] - 2026-05-15

### Changed
- Move project documentation into `docs/`.
- Move debug, quality, and standalone test helpers into dedicated script and test folders.
- Update helper scripts for their new repository paths.

### Removed
- Remove the unused Node package lockfile.
